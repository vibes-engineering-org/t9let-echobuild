export const PROJECT_TITLE = "Echo Build";
export const PROJECT_DESCRIPTION = "Visual builder for Farcaster Mini Apps with Base integration";
export const PROJECT_CREATOR = "t9let";
